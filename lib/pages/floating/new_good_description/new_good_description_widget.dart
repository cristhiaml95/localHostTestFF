...
import 'new_good_description_model.dart';
export 'new_good_description_model.dart';

class NewGoodDescriptionWidget extends StatefulWidget {
...
class _NewGoodDescriptionWidgetState extends State<NewGoodDescriptionWidget> {
  late NewGoodDescriptionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewGoodDescriptionModel());
                        ...
                        builder: (dialogContext) {
                          return Dialog(
                            ...
                            child: SureQueryWidget(
                              saveChangesP: () async {
                                await GoodDescriptionsTable().insert({
                                  'opis_blaga':
