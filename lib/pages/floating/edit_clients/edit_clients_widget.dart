...
class _EditClientsWidgetState extends State<EditClientsWidget> {
  ...
  void initState() {
    ...
    _model.orderNoTFController1 ??= TextEditingController();
    _model.orderNoTFFocusNode1 ??= FocusNode();

    _model.orderNoTFController2 ??= TextEditingController();
    _model.orderNoTFFocusNode2 ??= FocusNode();

    _model.orderNoTFController3 ??= TextEditingController();
    _model.orderNoTFFocusNode3 ??= FocusNode();

    _model.orderNoTFController4 ??= TextEditingController();
    _model.orderNoTFFocusNode4 ??= FocusNode();

    _model.orderNoTFController5 ??= TextEditingController();
    _model.orderNoTFFocusNode5 ??= FocusNode();

    _model.orderNoTFController6 ??= TextEditingController();
          ...
          return Container(
            ...
            child: Column(
              ...
              children: [
                Padding(
                  padding:
                      const EdgeInsetsDirectional.fromSTEB(28.0, 0.0, 28.0, 40.0),
                  child: Row(
                    mainAxisSize: MainAxisSize.max,
                                  ...
                                  child: SureQueryWidget(
                                    saveChangesP: () async {
                                      await ClientsTable().update(
                                        data: {
                                          'client': _model.orderNoTFController1
                                                          .text !=
                                                      ''
                                              ? _model.orderNoTFController1.text
                                              : containerClientsRow?.client,
                                          'address': _model.orderNoTFController2
                                                          .text !=
                                                      ''
                                              ? _model.orderNoTFController2.text
                                              : containerClientsRow?.address,
                                          'city': _model.orderNoTFController3
                                                          .text !=
                                                      ''
                                              ? _model.orderNoTFController3.text
                                              : containerClientsRow?.city,
                                          'country': _model.orderNoTFController4
                                                          .text !=
                                                      ''
                                              ? _model.orderNoTFController4.text
                                              : containerClientsRow?.country,
                                          'name_aiss': _model.orderNoTFController5
                                                          .text !=
                                                      ''
                                              ? _model.orderNoTFController5.text
                                              : containerClientsRow?.nameAiss,
                                          'vat_no': _model.orderNoTFController6
                                                          .text !=
                                                      ''
                                              ? _model.orderNoTFController6.text
                                              : containerClientsRow?.vatNo,
                                        },
