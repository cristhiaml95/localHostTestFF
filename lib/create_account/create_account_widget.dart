  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<UsersRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRow> createAccountUsersRowList = snapshot.data!;
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'vyc1ujqk' /* Let's get started by filling o... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium,
                                        ),
                                      ...
                                      Padding(
                                        ...
                                        child: FlutterFlowDropDown<String>(
                                          controller: _model
                                                  .userTypeDDValueController ??=
                                              FormFieldController<String>(null),
                                          options: [
                                            FFLocalizations.of(context).getText(
                                              '99r8wugx' /* administrator */,
                                            ),
                                            FFLocalizations.of(context).getText(
                                              'jw8uoqy2' /* employee */,
                                            )
                                      ...
                                      if (createAccountUsersRowList
                                              .where(
                                                  (e) => e.id == currentUserUid)
                                              .toList()
                                              .first
                                              .userType ==
                                          'administrator')
                                            ...
                                            children: [
                                              TextSpan(
                                                text:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  'dpf4qbt5' /* Already have an account?  */,
                                                ),
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              fit: BoxFit.cover,
                              image: Image.asset(
                                'assets/images/pexels-pat-whelen-5615442.jpg',
                              ).image,
                            ),
