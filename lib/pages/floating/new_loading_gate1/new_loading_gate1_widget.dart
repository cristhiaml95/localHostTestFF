...
class _NewLoadingGate1WidgetState extends State<NewLoadingGate1Widget> {
  ...
  void initState() {
    ...
    _model.rampTFController ??= TextEditingController();
                                  ...
                                  child: SureQueryWidget(
                                    saveChangesP: () async {
                                      await LoadingGatesTable().insert({
                                        ...
                                        'ramp': _model.rampTFController.text,
                                      });
                                    },
                                  ),
                                );
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    SizedBox(
                      width: 300.0,
                      child: TextFormField(
                        controller: _model.rampTFController,
                        ...
                        style: FlutterFlowTheme.of(context).bodyMedium,
                        validator: _model.rampTFControllerValidator
                            .asValidator(context),
                      ),
                    ),
                  ],
