...
class _NewGoodWidgetState extends State<NewGoodWidget> {
  ...
  void initState() {
    ...
    _model.goodTFController ??= TextEditingController();
              ...
              children: [
                ...
                Padding(
                  ...
                  child: SizedBox(
                    width: 280.0,
                    child: TextFormField(
                      controller: _model.goodTFController,
                      ...
                      style: FlutterFlowTheme.of(context).bodyMedium,
                      validator:
                          _model.goodTFControllerValidator.asValidator(context),
                    ),
                  ),
                ),
                Builder(
                            ...
                            child: SureQueryWidget(
                              saveChangesP: () async {
                                await GoodsTable().insert({
                                  'item': _model.goodTFController.text,
                                });
                              },
                            ),
                          );
